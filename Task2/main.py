...
#
# Funkcje build_model, run_experiments (trening + ewaluacja + wykresy w jednym bloku).
FIXED_HP = {
...
# ## 6. Blok B — głębokość
#
# Zmieniamy tylko hidden_layers. Po uruchomieniu porównaj wyniki i ustaw BEST_ARCH w następnej komórce.
experiments_b = [
...
# ## Wybór architektury (ręcznie)
#
# Na podstawie wyników bloku B wybierz architekturę do bloków C–E.
# Ręczny wybór architektury po analizie bloku B:
# B_depth_32: F1=0.9700 | B_depth_64_32: F1=0.9724 | B_depth_128_64_32: F1=0.9727
BEST_ARCH = [128, 64, 32]
